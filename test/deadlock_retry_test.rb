...
gem 'activerecord', ENV['ACTIVERECORD_VERSION'] || ' ~>5.0'
...
MockModel.singleton_class.prepend(DeadlockRetry)

class DeadlockRetryTest < Test::Unit::TestCase
  DEADLOCK_ERROR = 'MySQL::Error: Deadlock found when trying to get lock'.freeze
  TIMEOUT_ERROR = 'MySQL::Error: Lock wait timeout exceeded'.freeze
